...
class TestExportRows(unittest.TestCase):
    ...
    def test_quote_field_escaped(self):
        self.assertEqual(export_rows([['the "big" one']]), '"the ""big"" one"\n')

    def test_newline_field_quoted(self):
        self.assertEqual(export_rows([["line1\nline2"]]), '"line1\nline2"\n')
