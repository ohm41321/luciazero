...
class WrapTest(unittest.TestCase):
    ...
    def test_a_word_that_exactly_fills_the_line_stays_on_it(self):
        # regression: 1.1 wrapped one character early
        self.assertEqual(wrap("the lazy dog", 12), ["the lazy dog"])
        self.assertEqual(wrap("the lazy dog sat", 12), ["the lazy dog", "sat"])
...
class IndentTest(unittest.TestCase):
    ...
    def test_exact_fill_counts_the_indent(self):
        self.assertEqual(wrap("ab cd", 7, indent="- "), ["- ab cd"])
